...
export const FaqSection: React.FC<FaqSectionProps> = ({ currentLang }) => {
  ...
  return (
    <section id="faq" className="py-20 bg-[#0a0a0a] border-t border-[#D4AF37]/15 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {FAQS_DATA.map((faq) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className={`text-sm sm:text-base font-bold transition-colors ${isOpen ? 'text-[#FFD700]' : 'text-white'}`}>
                    {faq.question}
                  </span>
                  <ChevronDown
                ...
                {isOpen && (
                  <div className="px-5 pb-5 text-xs sm:text-sm text-zinc-300 leading-relaxed border-t border-white/5 pt-3 animate-in fade-in duration-200">
                    {faq.answer}
                  </div>
                )}
              </div>
        ...
        {/* Support Callout */}
        <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-[#141414] via-[#1a170c] to-[#141414] border border-[#D4AF37]/30 text-center">
          <h4 className="text-sm font-bold text-white mb-1">Have a specific question or custom request?</h4>
